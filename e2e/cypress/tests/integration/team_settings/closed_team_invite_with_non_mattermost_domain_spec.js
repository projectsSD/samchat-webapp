...
describe('Division Settings', () => {
    ...
    it('MM-T389 Invite new user to closed team with \'Allow only users with a specific email domain to join this division\' set to an email that is NOT \'sample.mattermost.com\'', () => {
