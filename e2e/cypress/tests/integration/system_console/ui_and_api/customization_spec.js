...
describe('Customization', () => {
    ...
    it('MM-T1205 - Can change Site Description setting', () => {
        ...
        cy.findByTestId('TeamSettings.CustomDescriptionTexthelp-text').find('span').should('be.visible').and('have.text', 'Description of service shown in login screens and UI. When not specified, "All division communication in one place, searchable and accessible anywhere" is displayed.');
