...
export type TeamUnread = {
    ...
    /** The number of unread mentions in channels on this division, not including DMs and GMs */
    mention_count: number;

    /** The number of unread mentions in root posts in channels on this division, not including DMs and GMs */
    mention_count_root: number;

    /**
     * The number of unread posts in channels on this division, not including DMs and GMs
     *
    ...
    /**
     * The number of unread root posts in channels on this division, not including DMs and GMs
     *
